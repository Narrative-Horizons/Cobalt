...
{
    public enum EActiveAttribType : uint
    {
        Float = 0x1406,
        FloatVec2 = 0x8B50,
        FloatVec3 = 0x8B51,
    ...
    public enum EActiveUniformBlockParameter : uint
    {
    ...
    public enum EActiveUniformType : uint
    {
        Int = 0x1404,
        Float = 0x1406,
        FloatVec2 = 0x8B50,
    ...
    public enum EAtomicCounterParameterName : uint
    {
    ...
    public enum EBeginFeedbackMode : uint
    {
        Points = 0x0000,
        Lines = 0x0001,
        Triangles = 0x0004,
    ...
    public enum EBlendingFactorDest : uint
    {
        Zero = 0,
        SrcColor = 0x0300,
    ...
    public enum EBlendingFactorSrc : uint
    {
        Zero = 0,
        SrcAlpha = 0x0302,
        OneMinusSrcAlpha = 0x0303,
    ...
    public enum EBlitFramebufferFilter : uint
    {
        Nearest = 0x2600,
        Linear = 0x2601,
    }

    public enum EBufferAccess : uint
    {
        ReadOnly = 0x88B8,
        WriteOnly = 0x88B9,
        ReadWrite = 0x88BA,
    ...
    [Flags]
    public enum EBufferAccessMask : uint
    {
        MapReadBit = 0x0001,
        MapWriteBit = 0x0002,
    ...
    public enum EBufferParameterName : uint
    {
        BufferSize = 0x8764,
        BufferUsage = 0x8765,
        BufferAccess = 0x88BB,
    ...
    public enum EBufferPointer : uint
    {
        BufferMapPointer = 0x88BD,
    }

    public enum EBufferTarget : uint
    {
        ArrayBuffer = 0x8892,
    ...
    public enum EBufferUsageHint : uint
    {
        StreamDraw = 0x88E0,
        StreamRead = 0x88E1,
        StreamCopy = 0x88E2,
    ...
    public enum EClampColorMode : uint
    {
        False = 0,
        FixedOnly = 0x891D,
        True = 1,
    ...
    public enum EClampColorTarget : uint
    {
    ...
    [Flags]
    public enum EClearBufferMask : uint
    {
    ...
    public enum EClipControlOrigin : uint
    {
        LowerLeft = 0x8CA1,
        UpperLeft = 0x8CA2,
    }

    public enum EClipControlDepth : uint
    {
        NegativeOneToOne = 0x935E,
        ZeroToOne = 0x935F,
    }

    public enum EConditionalRenderType : uint
    {
        QueryWait = 0x8E13,
        QueryNoWait = 0x8E14,
    ...
    public enum ECullFaceMode : uint
    {
        Front = 0x0404,
        Back = 0x0405,
        FrontAndBack = 0x0408,
    ...
    public enum EDrawBuffersEnum : uint
    {
        None = 0,
        FrontLeft = 0x0400,
        FrontRight = 0x0401,
    ...
    public enum EDrawBufferMode : uint
    {
        None = 0,
        FrontLeft = 0x0400,
        FrontRight = 0x0401,
    ...
    public enum EDrawElementsType : uint
    {
        UnsignedByte = 0x1401,
    ...
    public enum EFramebufferAttachment : uint
    {
    ...
    public enum EFramebufferErrorCode : uint
    {
    ...
    public enum EFramebufferPName : uint
    {
    ...
    public enum EFramebufferParameterName : uint
    {
    ...
    public enum EFramebufferTarget : uint
    {
    ...
    public enum EFrontFaceDirection : uint
    {
        Cw = 0x0900,
        Ccw = 0x0901,
    }

    public enum EGenerateMipmapTarget : uint
    {
        Texture1D = 0x0DE0,
        Texture2D = 0x0DE1,
        Texture3D = 0x806F,
    ...
    public enum EGetMultisamplePName : uint
    {
        SamplePosition = 0x8E50,
    }

    public enum EGetPName : uint
    {
    ...
    public enum EGetPointerParameter : uint
    {
        DebugCallbackFunction = 0x8244,
        DebugCallbackUserParam = 0x8245,
    }

    public enum EGetQueryObjectParam : uint
    {
        QueryResult = 0x8866,
        QueryResultAvailable = 0x8867,
    }

    public enum EGetQueryParam : uint
    {
        QueryCounterBits = 0x8864,
        CurrentQuery = 0x8865,
    }

    public enum EGetTextureParameter : uint
    {
        TextureWidth = 0x1000,
    ...
    public enum EGetTextureLevelParameter : uint
    {
        TextureWidth = 0x1000,
        TextureHeight = 0x1001,
        TextureDepth = 0x8071,
    ...
    public enum EGraphicResetStatus : uint
    {
        NoError = 0,
    ...
    public enum EMaterialFace : uint
    {
        Front = 0x0404,
        Back = 0x0405,
        FrontAndBack = 0x0408,
    ...
    public enum EPixelInternalFormat : uint
    {
        DepthComponent = 0x1902,
        Alpha = 0x1906,
        Rgb = 0x1907,
    ...
    public enum EPixelStoreParameter : uint
    {
        UnpackSwapBytes = 0x0CF0,
        UnpackLsbFirst = 0x0CF1,
        UnpackRowLength = 0x0CF2,
    ...
    public enum EPointParameterName : uint
    {
        PointSizeMin = 0x8126,
        PointSizeMax = 0x8127,
        PointFadeThresholdSize = 0x8128,
    ...
    public enum EProgramInterface : uint
    {
        Uniform = 0x92E1,
        UniformBlock = 0x92E2,
        AtomicCounterBuffer = 0x92C0,
    ...
    public enum EProgramInterfaceParameterName : uint
    {
    ...
    public enum EProgramParameter : uint
    {
    ...
    public enum EProgramResourceParameterName : uint
    {
        NameLength = 0x92F9,
        Type = 0x92FA,
        ArraySize = 0x92FB,
    ...
    public enum EProgramStageParameterName : uint
    {
    ...
    public enum EProvokingVertexMode : uint
    {
        FirstVertexConvention = 0x8E4D,
        LastVertexConvention = 0x8E4E,
    }

    public enum EQueryTarget : uint
    {
    ...
    public enum EReadBufferMode : uint
    {
        None = 0x0000,
        FrontLeft = 0x0400,
        FrontRight = 0x0401,
    ...
    public enum ERenderbufferParameterName : uint
    {
    ...
    public enum ERenderbufferStorage : uint
    {
        R3G3B2 = 0x2A10,
        Alpha4 = 0x803B,
        Alpha8 = 0x803C,
    ...
    public enum ERenderbufferTarget : uint
    {
        Renderbuffer = 0x8D41,
    }

    public enum EShaderParameter : uint
    {
        ShaderType = 0x8B4F,
        DeleteStatus = 0x8B80,
    ...
    public enum ESizedInternalFormat : uint
    {
        Rgba8 = 0x8058,
        Rgba16 = 0x805B,
        R8 = 0x8229,
    ...
    public enum ESubroutineParameterName : uint
    {
        NumCompatibleSubroutines = 0x8E4A,
        CompatibleSubroutines = 0x8E4B,
        UniformSize = 0x8A38,
    ...
    public enum ETextureBufferTarget : uint
    {
        TextureBuffer = 0x8C2A,
    }

    public enum ETextureParameter : uint
    {
        Nearest = 0x2600,
        Linear = 0x2601,
    ...
    public enum ETextureParameterName : uint
    {
        TextureBaseLevel = 0x813C,
        TextureBorderColor = 0x1004,
        TextureCompareMode = 0x884C,
    ...
    public enum ETextureTargetMultisample : uint
    {
        Texture2DMultisample = 0x9100,
    ...
    public enum ETransformFeedbackMode : uint
    {
        InterleavedAttribs = 0x8C8C,
        SeparateAttribs = 0x8C8D,
    }

    public enum ETransformFeedbackParameterName : uint
    {
        TransformFeedbackBufferBinding = 0x8C8F,
        TransformFeedbackBufferStart = 0x8C84,
        TransformFeedbackBufferSize = 0x8C85,
    ...
    public enum EVertexAttribParameter : uint
    {
        ArrayEnabled = 0x8622,
        ArraySize = 0x8623,
        ArrayStride = 0x8624,
    ...
    public enum EVertexAttribPointerParameter : uint
    {
        ArrayPointer = 0x8645,
    }

    public enum EVertexAttribFormat : uint
    {
        Byte = 0x1400,
        UnsignedByte = 0x1401,
        Short = 0x1402,
    ...
    public enum EVertexAttribPType : uint
    {
        UnsignedUInt2101010Reversed = 0x8368,
        UnsignedInt2101010Reversed = 0x8D9F,
    }

    public enum EVertexAttribPointerType : uint
    {
        Byte = 0x1400,
        UnsignedByte = 0x1401,
        Short = 0x1402,
