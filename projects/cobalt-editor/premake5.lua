project "Cobalt Editor"
    ...
    filter "system:windows"
        ...
        postbuildcommands {
            ...
            "xcopy /E /C /I /Y \"%{sln.location}dependencies\\physx@4.1.2\\bin\\$(Configuration)\\%{cfg.system}\" \"%{sln.location}bin\\$(Configuration)\\%{cfg.system}\\%{cfg.dotnetframework}\"",
